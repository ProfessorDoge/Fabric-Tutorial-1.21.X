package net.profdoge.tutorialmod.block;
...
public class ModBlocks {
    ...
    public static final Block EMERALD_REFINED_BLOCK = registerBlock("emerald_refined_block",
    ...
    public static void registerModBlocks() {
        ...
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.BUILDING_BLOCKS).register(fabricItemGroupEntries -> {
            fabricItemGroupEntries.add(ModBlocks.EMERALD_REFINED_BLOCK);
        });
    }
}
